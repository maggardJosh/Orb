package com.lionsteel.LD24.Utils
{
	...
	public class Flash
	{
		 ...
		 * 
		 */		
		public function start(colour:uint = 0xFFFFFF, duration:Number = 0.5, alphaStart:Number = 1):void
		{
			stop();
			this.colour = colour;
			
			alpha = alphaStart;
			alphaSubtract = alphaStart/duration;
		}
